                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-2.5 border-t border-slate-100 dark:border-slate-800 grid grid-cols-2 gap-2">
                        <button
                          onClick={() => toggleExpandQuote(q.id)}
                          className={`w-full py-2 rounded-xl font-bold inline-flex items-center justify-center gap-1.5 cursor-pointer text-xs transition-colors ${isExpanded
                        ...
                        {onDeleteQuote && (
                          <button
                            ...
                            className="w-full py-2 bg-rose-50 dark:bg-rose-950/60 hover:bg-rose-100 dark:hover:bg-rose-900/60 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-900/50 rounded-xl font-bold inline-flex items-center justify-center gap-1.5 cursor-pointer text-xs transition-colors"
                              ...
                              <td className="p-4 text-right whitespace-nowrap">
                                <div className="flex items-center justify-end gap-2 whitespace-nowrap">
                                  <button
                                    ...
                                    className={`px-3 py-1.5 rounded-lg font-bold inline-flex items-center gap-1 cursor-pointer text-xs transition-colors shrink-0 ${isExpanded
                                        ? 'bg-indigo-600 text-white shadow-2xs'
                                        : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200'
                                      }`}
                                  ...
                                  {onDeleteQuote && (
                                    <button
                                      ...
                                      className="px-3 py-1.5 bg-rose-50 dark:bg-rose-950/60 hover:bg-rose-100 dark:hover:bg-rose-900/60 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-900/50 rounded-lg font-bold inline-flex items-center gap-1 cursor-pointer text-xs transition-colors shrink-0"
                                      title="Excluir orçamento"
                                    >
                                      <Trash2 className="w-3.5 h-3.5" /> Excluir
                                    </button>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-in fade-in duration-150">
          <div className="bg-white dark:bg-[#12151c] rounded-2xl max-w-md w-full p-6 border border-slate-200 dark:border-[#202531] shadow-xl space-y-4">
            <div className="flex items-center gap-3 text-rose-600 dark:text-rose-400">
              ...
              <div>
                <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base">Excluir Orçamento</h3>
                <p className="text-xs text-slate-500 font-mono">#{deletingQuoteId}</p>
              </div>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              Tem certeza que deseja excluir este orçamento do sistema? Esta ação removerá o orçamento do banco de dados e não poderá ser desfeita.
            </p>
            <div className="flex items-center justify-end gap-2 pt-2">
              ...
              <button
                onClick={() => {
                  if (onDeleteQuote && deletingQuoteId) {
                    onDeleteQuote(deletingQuoteId);
                  }
