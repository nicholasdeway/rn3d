                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-slate-50 dark:bg-[#181c26] border-b border-slate-200 dark:border-[#202531] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">
                    <tr>
                      ...
                      <th className="p-4 text-center whitespace-nowrap">Ação</th>
                    </tr>
                  </thead>
                            ...
                            <td className="p-4 text-center whitespace-nowrap">
                              <div className="flex flex-col items-center justify-center gap-1.5 w-full">
                                <button
                                  type="button"
                                  onClick={() => setSelectedOrderForPdfModal(o)}
                                  className="w-44 px-3 py-1 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg font-bold text-xs inline-flex items-center justify-center gap-1.5 cursor-pointer transition-colors shadow-xs whitespace-nowrap"
                                ...
                                {!isFullyPaid ? (
                                  <button
                                    type="button"
                                    onClick={() => handleOpenPaymentModal(o)}
                                    className="w-44 px-3 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold text-xs inline-flex items-center justify-center gap-1.5 cursor-pointer shadow-xs whitespace-nowrap"
                                  >
                                    <HandCoins className="w-3.5 h-3.5" /> Registrar Recebimento
                                  </button>
                                ) : (
                                  <span className="w-44 px-3 py-1 bg-emerald-100 dark:bg-emerald-950/80 text-emerald-800 dark:text-emerald-300 rounded-lg font-bold inline-flex items-center justify-center gap-1 border border-emerald-300 dark:border-emerald-800/80 text-xs whitespace-nowrap">
                              ...
                              <div className="flex flex-col items-center justify-center gap-1.5 w-full">
                                ...
                                {onDeleteExpense && (
                                  <button
                                    ...
                                    className="p-1 bg-rose-50 dark:bg-rose-950/60 hover:bg-rose-100 text-rose-600 dark:text-rose-400 rounded-lg transition-colors cursor-pointer"
                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-slate-50 dark:bg-[#181c26] border-b border-slate-200 dark:border-[#202531] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">
                    <tr>
                      ...
                      <th className="p-4 text-center whitespace-nowrap">Ação de Recebimento</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800/80 font-medium">
                    {paginatedReceber.map((entry) => {
                            ...
                            <td className="p-4 text-center whitespace-nowrap">
                              <div className="flex flex-col items-center justify-center gap-1.5 w-full">
                                <button
                                  type="button"
                                  onClick={() => setSelectedOrderForPdfModal(o)}
                                  className="w-48 px-3 py-1 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg font-bold text-xs inline-flex items-center justify-center gap-1.5 cursor-pointer transition-colors shadow-xs"
                                  title="Visualizar PDF do Pedido em A4"
                                >
                                  <FileText className="w-3.5 h-3.5 text-indigo-500" /> Ver PDF
                                </button>
                                <button
                                  type="button"
                                  onClick={() => handleOpenPaymentModal(o)}
                                  className="w-48 px-3 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold text-xs inline-flex items-center justify-center gap-1.5 cursor-pointer shadow-xs whitespace-nowrap"
                                >
                                  <HandCoins className="w-3.5 h-3.5" />
                                  {paid > 0 ? `Quitar Saldo (R$ ${remaining.toFixed(2).replace('.', ',')})` : 'Registrar Recebimento'}
                                </button>
                              </div>
                            </td>
                          </tr>
